...
def main():
    ...
    for index, (input_image, _) in enumerate(mnist_testset):
        ...
        functions.save_output(input_image, masked_image, inpainted_image, index, output_folder)

        # Optional: Stop after processing 10 images (for quick testing)
        if index >= 9:  
            break
